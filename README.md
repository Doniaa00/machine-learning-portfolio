...
#### Classification
1. **Iris Flower Classification** - Multi-class classification with Logistic Regression
2. **Diabetes Diagnosis** - Medical diagnosis with emphasis on recall metrics

#### Regression
3. **California Housing - Linear Regression** - Basic linear regression for price prediction
4. **California Housing - Random Forest** - Advanced ensemble method comparison

### Unsupervised Learning

#### Clustering
5. **Customer Segmentation** - K-Means clustering for market segmentation
